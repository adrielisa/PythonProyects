...
for numero in range(1,16):
    cuadrado = numero ** 2  #Para obtener el cuadrado de cada número del rango
    suma_cuadrados += cuadrado #para sumar el resultado obtenido de cada cuadrado que saqué
